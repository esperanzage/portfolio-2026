export const caseStudies = [
  ...
  },
  {
    ...
    subtitle: 'A Custom fields system that let customers track their unique data right in the platform, helping over 100 customers ditch their external spreadsheets and move everything into one unified system.',
    role: 'Lead Designer',
    timeline: '~6 months',
    ...
    heroBlend: true,
    images: ['/customFieldsList.png'],
    tintFrom: '#EDE0CC',
    tintTo: '#E2D0B5',
    gradient: 'radial-gradient(ellipse 110% 90% at 50% 110%, #DDD4C0 0%, #E8DFCE 45%, #F2ECE2 100%)',
    accentColor: '#A07840',
    metrics: [
      { text: '100+', label: 'Customers using custom fields' },
      { text: '1500+', label: 'Fields in the platform' },
    ],
    problem: {
      intro: 'Property management companies handle diverse portfolios with unique data requirements based on property types, business models, and regional regulations. The standard platform provided core functionality but couldn\'t accommodate the specialised data needs of different customers.',
      painPoints: [
        'Maintain critical business data in external spreadsheets, making it difficult to centralise information',
        'Forced to use workarounds using generic platform fields',
        'Manually maintaining data across multiple sources',
        'Missing opportunities for comprehensive reporting and analysis',
      ],
    },
    solution: {
      intro: 'Custom Fields allowed users to create their own data fields, letting them capture and organise information specific to their business needs. Providing the flexibility to track anything from property-specific details to custom tenant requirements without relying on external systems. The system has continued to expand with additional field types and supported entities, demonstrating the value of designing extensible solutions.',
    },
    process: [
      {
        step: '01',
        title: 'Discovery & Problem Definition',
        description: 'Started by digging into customer support tickets and feature requests to understand what people actually needed. Also looked at how competitors handled custom fields since this is pretty common in other platforms. From all this research, we learned what types of data customers were tracking in external tools, which helped us prioritise our approach.',
      },
      {
        step: '02',
        title: 'Ideation & Technical Collaboration',
        description: 'Worked with our technical lead to figure out how we could actually build this. We needed to understand the technical constraints and figure out how to accommodate everything we\'d discovered. We defined where custom fields could live in our platform and designed what the migration path would look like for existing customers.',
      },
      {
        step: '03',
        title: 'Phase Breakdown & Planning',
        description: 'Broke the project into phases to ship quickly and gather feedback: Phase 1 → test custom fields on properties first; Phase 2 → extend to tenancies and contacts; Phase 3 → let customers migrate their existing data into the system.',
      },
    ],
    outcome: {
      statement: 'Supporting custom fields in our main entities',
      body: 'I designed the complete experience to create and manage the needed data points for their company based on their portfolio, process and individual needs.',
      highlights: [
        {
          title: 'Create and manage custom fields',
          content: 'Admins in the platform can easily create and manage custom fields across their companies. High level overview of all fields available, type and what entities they apply to.',
        },
        {
          title: 'Multiple field types supported',
          content: 'Customers can customise their fields input to keep data accurate by providing text, number, single and multi-select field types in the platform. Easy to define field type and an easy experience to manage options, number formatting, etc.',
        },
        {
          title: 'Field scoping and references for merge fields',
          content: 'There\'s a lot of additional functionality that needed to be tied in to custom fields, by adding references, property managers are able to embed their custom fields in communications sent from our platform.',
        },
      ],
    },
    outcome2: {
      image: '/customFields-importValues.png',
      statement: 'Migration is essential: Allow customers to import existing data',
      body: 'Recognised that customers had years of valuable data in external systems that needed to be preserved, I also designed a flow for them to import their data into the platform.',
      highlights: [
        {
          title: 'Pre-populated templates ready to start',
          content: 'Customers can download templates with their available fields and the selected entity list to ensure an easy import for all their existing data into our system.',
        },
        {
          title: 'Easy recovery from data formatting issues',
          content: 'To make sure customers could recover easily from errors in the formatting of their data, we displayed which field and row the issue was found, as well as easy to understand error highlighting messages.',
        },
      ],
    },
  },
